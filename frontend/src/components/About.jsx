        ...
        <div className="grid md:grid-cols-2 gap-16 mb-20">
          ...
          >
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <p>
                I specialize in creating responsive, accessible, and performant web applications using React and modern
                JavaScript. I'm also experienced in integrating AI capabilities to enhance user experiences.
              </p>
              <p>
